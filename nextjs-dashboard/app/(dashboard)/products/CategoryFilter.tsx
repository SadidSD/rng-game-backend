...
export function CategoryFilter({ categories }: { categories: Category[] }) {
    ...
    const getCategoryDotColor = (slug: string) => {
        ...
        if (s.includes('sealed')) return 'bg-emerald-500 border-emerald-400 dark:bg-emerald-600';
        if (s.includes('single')) return 'bg-teal-500 border-teal-400 dark:bg-teal-600';
            ...
            >
                ...
                >
                    <span className={cn(
                        ...
                        currentValue === "all" ? "bg-primary-foreground border-primary-foreground" : "bg-muted-foreground border-muted-foreground"
                    )} />
                    All Categories
                </button>
                ...
                {categories.map((cat) => {
                    const isActive = currentValue === cat.slug;
                    const dotColor = getCategoryDotColor(cat.slug);
                    return (
                        <button
                            key={cat.id}
