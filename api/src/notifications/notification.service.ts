...
export class NotificationService {
    ...
    async sendOrderConfirmationEmail(
        ...
        const subject = `✅ Order Confirmed — RNG Gamez #${orderData.orderId.substring(0, 8).toUpperCase()}`;
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 24px; background: #f9f9f9; border-radius: 12px; color: #333;">
            <h2 style="color: #6d28d9; margin-bottom: 8px;">Order Confirmed!</h2>
            ...
            <div style="background: white; border-radius: 8px; padding: 16px; margin: 16px 0; border: 1px solid #eaeaea;">
                ...
                <p style="margin: 4px 0 0;">Status: <span style="background: #dbeafe; color: #1e40af; padding: 2px 6px; border-radius: 4px; font-size: 0.85em; font-weight: bold;">PAID</span></p>
            </div>

            <h3 style="color: #555; margin-bottom: 8px;">Items Ordered</h3>
        ...
        try {
            ...
            this.logger.error(`Failed to send order confirmation email to ${customerEmail}: ${error.message}`);
        }
    }
